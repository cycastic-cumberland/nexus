...
class FileAccess : public SafeObject {
public:
...
public:
    ...
    explicit FileAccess(AccessType p_type, const bool& p_endian_swap = false) : SafeObject(), access_type(p_type), endian_swap(p_endian_swap) {}
};
