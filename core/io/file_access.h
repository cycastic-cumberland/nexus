...
class FileAccess : public ThreadSafeObject {
public:
...
public:
    ...
    explicit FileAccess(AccessType p_type, const bool& p_endian_swap = false) : ThreadSafeObject(), access_type(p_type), endian_swap(p_endian_swap) {}
};
